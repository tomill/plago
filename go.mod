module github.com/tomill/plago
...
replace github.com/g8rswimmer/go-twitter/v2 => github.com/socialdog-inc/go-twitter-v2/v2 v2.0.0-20250528011212-460c5fa3ac3c
